...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given code attribute.</summary>
    ///   <param name="code" type="String">An ID to search for, specified via the code attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
